    ...
    <footer className="bg-gray-900 text-white py-8 mt-20">
      <div className="container mx-auto flex flex-wrap">
        <div className="w-full md:w-1/3 text-center md:text-left">
          ...
          <ul className="mb-4">
            <li className="mt-2"><Link className="hover:underline">Men's Clothing</Link></li>
            <li className="mt-2"><Link className="hover:underline">Women's Clothing</Link></li>
            <li className="mt-2"><Link className="hover:underline">Kids &amp; Baby Clothing</Link></li>
          </ul>
        </div>
        <div className="w-full md:w-1/3 text-center md:text-left">
          ...
          <ul className="mb-4">
            ...
            <li className="mt-2"><Link className="hover:underline">Our Team</Link></li>
      ...
      <div className="container mx-auto mt-8">
        <div className="flex flex-wrap justify-between items-center">
          <div className="w-full md:w-1/2 text-center md:text-left">
            <p>&copy; 2023 VicStore All Rights Reserved.</p>
          </div>
